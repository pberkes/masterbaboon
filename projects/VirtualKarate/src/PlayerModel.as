package  {
	...
	public class PlayerModel {
		...
		/*
		 * Init history at random, to create a less predictable intial phase.
		 */
		protected function initHistory():void {
			history = new Array(3);
			for (var i:int = 0; i < 3; i++) {
				history[i] = Math.floor(Math.random() * 4.);
			}
		}
		 ...
		 * Update: kicks are much more profitable, make all kick moves more probable.
		 */
