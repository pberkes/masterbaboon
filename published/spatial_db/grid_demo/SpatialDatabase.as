package  
{
	...
	/**
	 * Spatial database to hold Shape elements on a grid.
	...
	public class SpatialDatabase 
	{
		...
		public function SpatialDatabase(w:int, h:int, sz:int) {
			 ...
			 * they lack basic methods to compute their size, or update them
		 ...
		 */
		public function register(s:Shape):void {
		 ...
		 */
		public function remove(s:Shape):void {
